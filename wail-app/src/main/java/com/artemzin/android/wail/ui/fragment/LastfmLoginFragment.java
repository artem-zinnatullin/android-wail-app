...
public class LastfmLoginFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        loginEditText    = (EditText) view.findViewById(R.id.lastfm_login_login_edit_text);
        passwordEditText = (EditText) view.findViewById(R.id.lastfm_login_password_edit_text);
        loginButton = (Button) view.findViewById(R.id.lastfm_login_login_button);
